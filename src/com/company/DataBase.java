...
class DataBase<T> {
    ...
    private static final String USER = "s245031";
    private static final String PASS = "fuy378";
    ...
    private void createTable(String name){
        ...
        sqlQuery.append(" (id smallint PRIMARY KEY," +
    ...
    int insert(Chest object) {
        StringBuilder sqlQuery = new StringBuilder("INSERT INTO " + "Chests" + " VALUES (" +
                "0, '" + object.getName() + "', " + object.getSum() + ", " + object.state[0] + ", " + object.state[1] + ");");
